...
public class AppUtils extends Utils {
    ...
    public static void updateChildDeath(@NonNull EventClient eventClient) {
        ...
        values.put(Constants.KEY.DATE_REMOVED, org.smartregister.child.util.Utils.convertDateFormat(client.getDeathdate().toDate(), org.smartregister.child.util.Utils.DB_DF));
